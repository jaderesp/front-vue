...
const socketCtr = require('../src/controllers/socket/Socket_controller');
...
app_.then(async function (routes) {
  ...
  //var spinnies = new Spinnies();
  spinnies.add('server-screen', { text: 'Sistema  Iniciado na porta:' + port, color: 'yellow' });
